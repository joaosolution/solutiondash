...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <img src="<?= base_url('img/SolutionSoftwareNew.png') ?>" >
  <!-- /.login-logo 
      <a class="h1"><b style = "font-family:garamond,arial,helvetica; color:DarkRed;">SOLUTION</b> DashBoard</a>
    -->
    </div>
    <div class="card-body">
      <p class="login-box-msg"><?= (isset($alert) && $alert == "error_login") ? "<span style='color: red'>Usuário ou senha incorreto</span>" : "Informe o usuário e senha" ?></p>
